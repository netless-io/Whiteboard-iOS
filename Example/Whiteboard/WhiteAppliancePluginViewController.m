...
static NSString * const kAppliancePluginRoomToken = @"NETLESSROOM_";
...
- (instancetype)init
{
    if (self = [super init]) {
        ...
        slideParams.resolution = @1;
        slideParams.maxResolutionLevel = @2;
