...
## [2.16.135] - 2026-05-19
- `WhiteRoom` 新增 `setWindowBoxState:` 方法，用于设置窗口盒子状态。
- `WhiteRoom` 新增 `querySlidePageState:completionHandler:` 方法，用于查询 Slide App 当前页码状态。
- `WhiteSlideDelegate` 新增 `onSlidePageStateChanged:` 回调，用于监听 Slide App 页码状态变化。
- 新增 `WhiteSlidePageState`，用于描述 Slide App 当前页码和总页数。
## [2.16.134] - 2026-04-13
...
## [2.16.108] - 2024-12-05
- 更新 `@netless/appliance-plugin` 至 1.1.6
- 更新 `NTLBridge` 至 3.2.0
## [2.16.107] - 2024-11-06
- 更新 `@netless/appliance-plugin` 至 1.1.2
## [2.16.106] - 2024-10-31
- 更新 `@netless/appliance-plugin` 至 1.1.1
## [2.16.105] - 2024-10-11
- 新增 `WhiteSlideDelegate.onSlideError` 回调，用于监听 PPT 渲染错误
- 新增 `WhiteSDK.recoverSlide` 方法，用于恢复 PPT 渲染
- 更新 `@netless/appliance-plugin` 至 1.1.0
## [2.16.104] - 2024-09-10
- 更新 `@netless/window-manager`至 0.4.75
## [2.16.103] - 2024-09-02
...
## [2.16.90] - 2024-03-26
- 更新 `window-manager` 至 0.4.69
- MediaPlayer 混音特定支持
## [2.16.89] - 2024-03-13
- 新增 `WhiteWindowParams.overwriteStyles`，用于窗口样式覆盖
## [2.16.88] - 2024-02-05
- 更新 `@netless/app-slide` 至 0.2.55
- 更新 `@netless/slide-rtc-plugin` 至 1.3.1
## [2.16.87] - 2024-02-04
...
## [2.16.75] - 2023-10-12
- 更新 `window-manager` 至 0.4.62。AppDocsViewer 支持抓手工具
## [2.16.74] - 2023-09-27
