...
## [2.17.0-alpha.29] - 2024-03-13
- Native log for webview console
...
- 更新 @netless/slide 到 1.1.2
- 更新 @netless/window-manager 到 1.0.0-canary.79
## [2.17.0-alpha.26] - 2023-07-18
- 更新 `@netless/slide` 至 1.1.1
...
## [2.17.0-alpha.18] - 2023-02-06
- 新增 `pencilEraserSize`
## [2.17.0-alpha.17] - 2022-12-28
- 更新 `@netless/app-slide` 至 0.3.0-canary.17
## [2.17.0-alpha.12] - 2022-11-17
- 修复只用 ApplePencil 画笔的一个初始化错误
...
## [2.17.0-alpha.8] - 2022-10-24
- 更新 `@netless/window-manager`至 1.0.0-canary.68
## [2.17.0-alpha.7] - 2022-10-11
- 修复 windowParams 没传无法加入房间的错误
## [2.17.0-alpha.6] - 2022-09-28
- 更新 `@netless/app-slide` 至 0.3.0-canary.13
## [2.17.0-alpha.3] - 2022-09-27
- 更新 `@netless/window-manager`至 1.0.0-canary.61
...
`WhiteWindowParams` 新增 `containerStyle` `stageStyle` `defaultBoxBodyStyle` `defaultBoxStageStyle` `theme` 属性，用于设置窗口样式## [2.16.67] - 2023-08-22
...
- `WhiteSdkConfiguration` 新增 `whiteSlideAppParams` 配置项用于 SlideApp
  显示配置。当前支持配置 `whiteSlideAppParams.showRenderError`，用于配置显示/隐藏渲染错误提示
## [2.16.56] - 2023-02-16
...
## [2.16.48] - 2022-11-15
- 更新 `@netless/app-slide` 至 0.2.23
## [2.16.47] - 2022-10-28
- 更新 `white-web-sdk` 至 2.16.37
## [2.16.46] - 2022-10-24
- 更新 `@netless/slide-rtc-plugin` 至 0.8.4
...
## [2.16.42] - 2022-09-26
- 更新 `Whiteboard.podspec`## [2.16.41] - 2022-09-26
...
- 新增 `SyncedStore` 模块，用于存储和更新自定义业务状态数据
- 修复 `drawOnlyPencil` 功能在单窗口模式下切换到 Clicker 并且不恢复的错误
- 修复加入房间时的日志丢失问题
## [2.16.27] - 2022-07-07
...
- 修复只读用户的重连刷新问题。
## [2.16.25] - 2022-06-24
- 更新 `white-web-sdk` 至 2.16.25
- 新增 `SyncPlayer` 支持，可以用于同步播放多段视频与白板播放器
## [2.16.24] - 2022-06-09
...
- `<span style="color: red">`WhiteRoomConfig 现在需要强制配置 UID，其初始化方法，更改为 `- (instancetype)initWithUUID:(NSString *)uuid roomToken:(NSString *)roomToken uid:(NSString *)uid userPayload:(id _Nullable)userPayload`和 `- (instancetype)initWithUUID:(NSString *)uuid roomToken:(NSString *)roomToken uid:(NSString *)uid`，移除旧的初始化 API。
- `<span style="color: red">`移除 WhiteSDK 部分 API，强制使用 WhiteRoomConfig 调用加入房间接口。`
...
- `<span style="color: red">`不再兼容 iOS 9
## [2.13.21] - 2021-09-09
...
## [2.8.0] - 2020-05-14
- `<span style="color:red;">`不兼容改动：SDK 初始化时，新增必须要的 APP identitier 参数（详情见 开发者文档中，查看 APP identitier 一栏）
