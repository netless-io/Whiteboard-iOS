...
- (instancetype)initWithWhiteBoardView:(WhiteBoardView *)boardView config:(WhiteSdkConfiguration *)config commonCallbackDelegate:(id<WhiteCommonCallbackDelegate>)callback effectMixerBridgeDelegate:(id<WhiteAudioEffectMixerBridgeDelegate>)effectMixer pcmDataDelegate:(id<WhiteAudioPcmDataDelegate>)pcmDataDelegate {
    return [self initWithWhiteBoardView:boardView config:config commonCallbackDelegate:callback audioMixerBridgeDelegate:nil effectMixerBridgeDelegate:effectMixer pcmDataDelegate:pcmDataDelegate];
}
